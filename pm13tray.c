...
/* Write XPM data to a temporary file and return the filename */
...
static AppIndicator *create_tray_icon() {
    ...
    GtkWidget *menu_item = gtk_menu_item_new_with_label("Open Pupmode 13 Settings");
    g_signal_connect(menu_item, "activate", G_CALLBACK(tray_icon_on_click), NULL);
